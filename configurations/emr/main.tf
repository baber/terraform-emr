...
resource "aws_emr_cluster" "emr-spark-cluster" {
  ...
  ec2_attributes {
    key_name                          = "developer"
    subnet_id                         = "${module.vpc.main-subnet-id}"
    emr_managed_master_security_group = "${module.vpc.security-group-name}"
    emr_managed_slave_security_group  = "${module.vpc.security-group-name}"
